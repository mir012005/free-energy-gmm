...
loss_type="work_variance": Var(W^θ) → 0 at optimum (avoids W→0 degeneracy)
"""
...
def train(
    ...
    def loss_fn(seeds, params):
        ...
        loss  = works.var() if loss_type == "work_variance" else works.mean()
